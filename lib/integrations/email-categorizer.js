...
function categorizeEmail(email) {
    ...
    if (vendorDealConfig && containsKeyword(searchableText, vendorDealConfig.keywords)) {
        ...
        try {
            bulletinBoard.postBulletin('email-monitor', 'vendor_deal', {
                from: email.from,
 ...
 * @returns {{ byCategory: Object<string, number>, flagged: Array, total: number }}
 */
 ...
 *
 * @param {{ byCategory: Object<string, number>, flagged: Array, total: number }} summary - Categorization summary
