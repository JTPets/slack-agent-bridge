...
const SOURCE = {
    ...
    // LOGIC CHANGE 2026-09-15: was 'registry:agents.json'. Definitions are now
    // agents/<id>/agent.md; the label has to name the file someone would open.
    REGISTRY: 'registry:agent.md',             // tracked; on-box edits are lost to git reset --hard
